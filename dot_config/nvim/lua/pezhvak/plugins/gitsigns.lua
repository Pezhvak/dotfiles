...
return {
  {
    ...
    opts = {
      ...
      on_attach = function(bufnr)
        ...
        map('n', '<leader>gl', gitsigns.toggle_linehl, { desc = 'git toggle [l]ine highlight' })
        map('n', '<leader>gB', gitsigns.toggle_current_line_blame, { desc = 'git toggle inline [B]lame' })
